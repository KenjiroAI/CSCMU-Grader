...
def do_setup():
    ...
    package_data = {
        ...
        "cms.server": [
            ...
            os.path.join("static", "css", "themes", "*.*"),
            os.path.join("static", "css", "themes", "basic", "*.*"),
            os.path.join("static", "css", "themes", "basic", "assets", "*.*"),
            os.path.join("static", "css", "themes", "basic", "assets", "fonts", "*.*"),
            os.path.join("static", "css", "themes", "default", "*.*"),
            os.path.join("static", "css", "themes", "default", "assets", "*.*"),
            os.path.join("static", "css", "themes", "default", "assets", "fonts", "*.*"),
            os.path.join("static", "css", "themes", "default", "assets", "images", "*.*"),
